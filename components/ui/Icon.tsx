...
const icons: { [key: string]: React.ReactNode } = {
  ...
  Brush: (
    <>
      <path d="M10 21.35 2.65 14a6 6 0 0 1 0-8.5 6 6 0 0 1 8.5 0l.15.15" />
      <path d="m21.5 6.5-1 1-2-2-1 1-1-1-2-2-1 1-1-1-2-2-1 1-1-1-2-2-1 1 .15.15.15" />
    </>
  ),
  Wind: <><path d="M17.7 7.7a2.5 2.5 0 1 1 1.8 4.3H2" /><path d="M9.6 4.6A2 2 0 1 1 11 8H2" /><path d="M12.6 19.4A2 2 0 1 0 14 16H2" /></>,
  Sparkles: (
    <>
      <path d="M9.9 2.2 11 0l1.1 2.2 2.2 1.1-2.2 1.1-1.1 2.2L11 4.4 9.9 3.3Z" />
      <path d="m20 11-2.2.1-1.1 2.2-1.1-2.2L13.4 11l2.2-.1 1.1-2.2 1.1 2.2Z" />
      <path d="m3.3 11 1.1 2.2 1.1-2.2L7.7 11l-2.2-.1-1.1-2.2-1.1 2.2Z" />
    </>
  ),
  ...
  Clapperboard: (
    <>
      ...
      <path d="m20.2 6-1 2.9-10.4-3.1L12 3l8.2 3z" />
      <path d="M2.9 14.1 22 9l-1.6 4.8c-.3 1-1.3 1.6-2.4 1.2l-13.5-4c-1-2.9-1.6-1.3-1.2-2.4z" />
    </>
  ),
  SkipForward: (
    <>
